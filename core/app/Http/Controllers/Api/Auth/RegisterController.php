    ...
    */
    ...
    protected function validator(array $data)
    {
        ...
        $validate     = Validator::make($data, [
            ...
            'agree.boolean'=>'The agreement field must be true or false'
        ]);
    ...
    protected function create(array $data)
    {
        ...
        $user->username  = strtolower(explode('@', $data['email'])[0]) . rand(100, 999);
        ...
        // Commenting out admin notification - table doesn't exist yet
        /*
        ...
        */
        ...
        // Commenting out user login tracking - table doesn't exist yet
        /*
        //Login Log Create
        $ip = getRealIP();
