...
class WithdrawalController extends Controller
{
    ...
    {
        $pageTitle = 'Pending Disbursements';
    ...
    {
        $pageTitle = 'Approved Disbursements';
    ...
    {
        $pageTitle = 'Rejected Disbursements';
    ...
    {
        $withdrawalData = $this->withdrawalData($scope, true);
        $withdrawals = $withdrawalData['data'];
        $summary = $withdrawalData['summary'] ?? null;

        $pageTitle = ucfirst($scope ?? 'All') . ' Withdrawals Report';
        
        $pdf = PDF::loadView('admin.withdraw.pdf', compact('pageTitle', 'withdrawals', 'summary'));
