...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function(){
     ...
     //Loan-documents
     Route::controller('DocumentsController')->prefix('documents')->name('document.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });

    //Routes for country here
    // Country Management
    Route::controller('CountryController')->prefix('country')->name('country.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    // Region Management
    Route::controller('RegionController')->prefix('region')->name('region.')->group(function () {
        Route::get('fetch', 'fetchRegions')->name('fetch'); // Ensure this route is defined
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    // Routes for daily and monthly targets
    Route::controller('TargetController')->prefix('targets')->name('targets.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
    ...
    //============Routes for roles and permissions functionality go here================//
    ...
    Route::prefix('permissions')->name('permissions.')->group(function () {
        ...
        Route::controller('AssignController')->group(function () {
            Route::get('assign-permissions', 'assignPermissions')->name('assign.permissions');
            Route::post('assign-permissions', 'storeAssignedPermissions')->name('assign.permissions.store');
        });
    });
    ...
    Route::controller('ManageAgentsController')->name('field-agents.')->prefix('field-agents')->group(function(){
        Route::get('/', 'allUsers')->name('all');
        Route::get('active', 'activeUsers')->name('active');
        Route::get('banned', 'bannedUsers')->name('banned');
        Route::get('email-verified', 'emailVerifiedUsers')->name('email.verified');
    ...
    Route::name('withdraw.')->prefix('withdraw')->group(function(){
        ...
        Route::controller('WithdrawalController')->name('data.')->group(function(){
            ...
            Route::post('reject', 'reject')->name('reject');
            Route::get('export/{scope?}', 'export')->name('export');
        });
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function(){
        ...
        Route::get('transaction/export/pdf/{user_id?}', 'exportTransactionPdf')->name('transaction.export.pdf');
        Route::get('login/history/export/pdf', 'exportLoginHistoryPdf')->name('login.history.export.pdf');
        Route::get('notification/history/export/pdf', 'exportNotificationHistoryPdf')->name('notification.history.export.pdf');
    });
    ...
    // Timesheet Manager
    Route::controller('TimesheetController')->name('timesheets.')->prefix('timesheets')->group(function(){
        Route::get('/', 'index')->name('index');
        Route::get('export-pdf', 'exportPdf')->name('export.pdf');
    });
    ...
    Route::prefix('agent-requests')->name('agent-requests.')->group(function () {
        Route::get('/', [\App\Http\Controllers\Admin\AgentRequestController::class, 'index'])->name('index');
        Route::post('{id}/approve', [\App\Http\Controllers\Admin\AgentRequestController::class, 'approve'])->name('approve');
        Route::post('{id}/reject', [\App\Http\Controllers\Admin\AgentRequestController::class, 'reject'])->name('reject');
        Route::get('export/pdf', [\App\Http\Controllers\Admin\AgentRequestController::class, 'exportPdf'])->name('export.pdf');
    });
});
