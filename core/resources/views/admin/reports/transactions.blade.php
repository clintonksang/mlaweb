...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="d-flex justify-content-end align-items-center mb-3 px-3">
            <a href="{{ route('admin.report.transaction.export.pdf', request()->user_id) }}?{{ http_build_query(request()->except('page')) }}" class="btn btn--primary" target="_blank">
                <i class="la la-file-pdf"></i> @lang('Export PDF')
            </a>
        </div>
        <div class="card  ">
