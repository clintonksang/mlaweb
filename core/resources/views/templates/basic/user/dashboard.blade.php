...
@section('content')
    <div class="dashboard-inner">
        ...
        <h3 class="my-4"> @lang('My Pending Loans')</h3>
        <div class="card custom--card ">
            <div class="table-responsive">
                <table class="table table--responsive--md">
                    <thead>
                    ...
                    <tbody>
                        @forelse ($userPendingLoans as $loan)
                            <tr>
                                <td>
                                    <span class="text--primary"> {{ __($loan->loan_number) }}</span>
                                </td>
        ...
        @if ($totalPendingLoans > 5)
            <span class="d-flex justify-content-center">
                <a href="{{ route('user.loan.list') }}?status={{ Status::LOAN_PENDING }}" class="btn btn--base my-2">
                    @lang('See All Pending')</a>
            </span>
        @endif
